...
class DataUser: ParsableModel {
   static let  sharedInstance = DataUser.init(dictionary: ["userID":NSNumber.init(value: 0)])
    var activeUser:DataUser! //= Data.init(dictionary: ["userID":NSNumber.init(value: 0)])
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         branchAddress = aDecoder.decodeObject(forKey: "branchAddress") as? AddressInfo
         branchID = aDecoder.decodeObject(forKey: "branchID") as? NSNumber
         company = aDecoder.decodeObject(forKey: "company") as? CompanyJson
         ...
         permanentAddress = aDecoder.decodeObject(forKey: "permanentAddress") as? AddressInfo
    ...
    required init(dictionary: [String : Any]) {
       ...
       // static let activeUser = Data.init(dictionary: dictionary)
        ...
        branchAddress = AddressInfo().initWithdic(dic: Common.returndefaultdictionary(dic: dictionary, keyvalue:"branchAddress"))
        
        branchID = Common.returndefaultnsnumber(dic: dictionary, keyvalue: "branchID")
        company = CompanyJson.init(dictionary:Common.returndefaultdictionary(dic: dictionary, keyvalue:"company") )
        ...
        permanentAddress = AddressInfo().initWithdic(dic:Common.returndefaultdictionary(dic:dictionary,keyvalue: "permanentAddress") )
    ...
    */
    ...
    static let activeuser: DataUser = {
        let instance = sharedInstance.activeUser
        // Setup code
        return instance ?? DataUser.init(dictionary: [:])
    }()
//    class func setActiveUser(dic:[String:Any]){
//        Data.activeUser = Data.init(dictionary: dic)
//    }
//    class func getActiveUser()->Data{

...
open class LUAutocompleteView: UIView {
    ...
    public var upPopUpDirection: Bool = false 
    ...
    */
    public var throttleTime: TimeInterval = 0.01
    /// The maximum height of autocomplete view. Default value is `200.0`.
    public var maximumHeight: CGFloat = 210.0
...
//            height = tableView.contentSize.height
            height = CGFloat(elements.count) * rowHeight
    ...
    */
    ...
    private func setupConstraints() {
        ...
        if upPopUpDirection == true {
            constraints.append(bottomAnchor.constraint(equalTo: textField.topAnchor))
        } else {
            constraints.append(topAnchor.constraint(equalTo: textField.bottomAnchor))
        }
    ...
    @objc private func getElements() {
        ...
        guard let text = textField?.text, !text.isEmpty else {
            elements.removeAll()
            dataSource.autocompleteView(self, elementsFor: "") { elements in
